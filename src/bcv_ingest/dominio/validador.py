...
de la misma fila. Se comparan ambos spreads y una divergencia mayor a la tolerancia
envía la fila a cuarentena.
"""
...
TOLERANCIA_SPREAD_ENTRE_BASES = 0.05
...
class ValidadorDominio:
    ...
    def _validar_tasa(self, tasa: TasaCruda) -> str | None:
        ...
        if abs(spread_usd - spread_bs) > TOLERANCIA_SPREAD_ENTRE_BASES:
            return (
                "spread BID/ASK incoherente entre bases "
